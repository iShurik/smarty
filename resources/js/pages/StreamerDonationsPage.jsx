...
import { Badge, Card, Col, Form, Pagination, Row, Table } from 'react-bootstrap';
...
export default function StreamerDonationsPage() {
  ...
  useEffect(() => {
    ...
    const loadDonations = async () => {
      ...
      try {
        const { data } = await axios.get('/api/v1/streamer/donations', {
          params: queryParams,
        });
  ...
  return (
    <div className="d-flex flex-column gap-3">
      <div>
        <h1 className="section-title fs-4 mb-1">Донаты стримера</h1>
        <p className="section-subtitle">Список донатов, фильтры и предупреждения по YouTube.</p>
      </div>
      ...
      <Card className="shadow-sm border-0 bg-light">
        <Card.Body>
          <Row className="g-3 align-items-end">
            ...
            <Col md={4}>
              <Form.Group controlId="donationFrom">
            ...
            <Col md={4}>
              <Form.Group controlId="donationTo">
            ...
            <Col md={4}>
              <Form.Group controlId="donationSort">
            ...
            <Col md={4}>
              <Form.Group controlId="donationPerPage">
            ...
            <tbody>
              {donations.length === 0 ? (
                ...
                donations.map((donation) => (
                  <tr key={donation.id}>
                    <td>
                      <div className="fw-semibold">{donation.donor_name}</div>
                    ...
                    <td>
                      <Badge bg="secondary">{statusLabels[donation.status]}</Badge>
                    </td>
